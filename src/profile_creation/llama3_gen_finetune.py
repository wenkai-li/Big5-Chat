...
class CO3Sotopia():
    def __init__(self, args):
        ...
        class Args:
            model_id = "/compute/babel-4-33/jiaruil5/.cache/models--TechxGenus--Meta-Llama-3-70B-Instruct-GPTQ/snapshots/e147aa8799dd05d5077f60c79be0d972b002b3ac/"
            cache_dir = None
    ...
    def generate_expert_messages(self, big_five_level):
        ...
        prompt = f"You are a helpful assistant with the following Big Five personality traits: {prompt_person_str}\n"
        messages = [
            {"role": "user", "content": prompt}
        ]
        return messages
...
if __name__ == '__main__':
    ...
    parser.add_argument("--in_file", type=str, default="./soda_data/test.json", help="The file of the sampled soda training data")
