    ...
    def __init__(self, args):
        ...
        class ArgsExpert:
            ...
            if args.person_trait == 'o':
                model_id = "./generator/generator_whole_o_1e-6/"
            elif args.person_trait == 'c':
                model_id = "./generator/generator_whole_c_1e-6/"
            elif args.person_trait == 'e':
                model_id = "./generator/generator_whole_e_1e-6/"
            elif args.person_trait == 'a':
                model_id = "./generator/generator_whole_a_1e-6/"
            elif args.person_trait == 'n':
                # model_id = "/data/user_data/wenkail/llm_personality/generator/generator_whole_n_1e-6/"
                model_id = "./generator/generator_whole_n_1e-6/"
            cache_dir = None
            lora = False

        self.model = DExpertGenerator(args=Args, args_expert=ArgsExpert)
        self.data = pd.read_json(args.in_file).to_dict(orient='records')
...
if __name__ == '__main__':
    ...
    parser.add_argument("--in_file", type=str, default="./soda_data/sample_10000.json", help="The file of the sampled soda training data")
    parser.add_argument("--out_file", type=str, default="./profiles/env_profiles.jsonl")
