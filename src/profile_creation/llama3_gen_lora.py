    ...
    def __init__(self, args):
        ...
        class ArgsExpert:
            ...
            if args.person_trait == 'o':
                lora_model_path = "./generator/generator_whole_o_1e-6/"
            elif args.person_trait == 'c':
                lora_model_path = "./generator/generator_whole_c_1e-6/"
            elif args.person_trait == 'e':
                lora_model_path = "./generator/generator_whole_e_1e-6/"
            elif args.person_trait == 'a':
                lora_model_path = "./generator/generator_whole_a_1e-6/"
            elif args.person_trait == 'n':
                lora_model_path = "./generator/generator_whole_n_1e-6/"
            cache_dir = None
            lora = True
...
if __name__ == '__main__':
    ...
    parser.add_argument("--in_file", type=str, default="./soda_data/sample_10000.csv", help="The file of the sampled soda training data")
